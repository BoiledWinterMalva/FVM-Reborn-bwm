function can_target_on(card_target_type,enemy_target_type){
	...
	if enemy_target_type == "diver"{
		if card_target_type == "throw" 
		|| card_target_type == "track" 
		|| card_target_type == "rotate"  
		|| card_target_type == "d_fruit"
		|| card_target_type == "split"{
			return true
		}
	}
