...
if parent_body.flash_value >0{
	
    draw_self()
	shader_set(hit_effect_2);
	draw_sprite_ext(sprite_index,image_index,x,y,image_xscale,image_yscale,image_angle,c_white,parent_body.flash_value/200);
	shader_reset();
