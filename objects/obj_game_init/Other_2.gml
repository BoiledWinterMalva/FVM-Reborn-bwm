...
//{//测试版设置初始存档
//edit_gem_max_level("ghost_strike_gem",15)
//edit_gem_max_level("ghost_spark_gem",15)
//edit_gem_max_level("ghost_pact_gem",15)
//unlock_card("save_god",16,3,8)
//unlock_card("power_god",16,3,8)
//unlock_card("sheng_huo",16,3,8)
